...
~~如果你是一个生电大佬，非常熟悉 MASA 系列模组，觉得原版的MASA系列模组还是太好用了的话，可以尝试下载这个资源包来抹平您的大脑皮层（笑）你也可以把这个翻译包假扮成其他资源包后发给你的朋友，硬控他们几分钟。~~
...
注: 由于新版本的 Masa 模组加入了翻译覆盖功能（即`translationOverides`），会覆盖原版的资源包翻译。因此在新版本中，你需要在 MaLiLib 中把该功能设置为`False`才能正常加载此翻译包。
